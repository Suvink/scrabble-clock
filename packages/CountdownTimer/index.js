/*
 * Modified version of react-native-countdown-component
 * Original project: https://github.com/talalmajali/react-native-countdown-component
 *
 * Original Code:
 * Copyright (c) 2019 Talal Majali
 * Licensed under the MIT License (https://github.com/talalmajali/react-native-countdown-component/blob/master/LICENSE).
 *
 * Modifications and Enhancements:
 * Copyright (c) 2023 Suvin Kodituwakku
 * Licensed under CC BY-NC 4.0 (https://creativecommons.org/licenses/by-nc/4.0/)
 *
 * This modified version is provided under CC BY-NC 4.0.
 * However, portions of the original MIT-licensed code remain under MIT.
...
class CountDown extends React.Component {
    ...
    _handleAppStateChange = (currentAppState) => {
        ...
        if (currentAppState === 'active' && wentBackgroundAt && this.props.running) {
            //User comes from the background
    ...
    renderDigit = (d) => {
        ...
        return (
            <View style={[styles.digitCont, { width: size * 2.1, height: size * 2.6 }, digitStyle]}>
                {this.state.isReverse ? (
                    <Text style={[styles.digitTxt, { fontSize: 100 }, digitTxtStyle]}>{d}</Text>
                ) : (
    ...
    renderMinusSeparator = () => {
        ...
        return (
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                <Text style={[styles.minusSeparatorTxt, { fontSize: size }, separatorStyle]}>{'-'}</Text>
            </View>
        );
    };
